...
{
	private static _MODULES:Array<IModuleDefinition> =
		[
			{
				...
				attributes: [
					{
						id: 'fftSize',
						label_short: 'fft', // todo is this the only label? then maybe rename it? or add a label that is longer
	...
	public static findByType(type:string):IModuleDefinition
	{
		return this._MODULES.find(module => module.type === type);
	}

	public static findByCategory(category):Array<IModuleDefinition>
	{
