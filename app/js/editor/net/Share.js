define([
	...
	Share.prototype = Object.create(AbstractOverlayElement.prototype);
	Share.prototype.constructor = Share;

	function Share(patch)
	{
		// init extended setup
		this.containerId = 'share';
		AbstractOverlayElement.call(this, 400, 200, this.containerId);
	...
	Share.prototype.show = function()
	{
		...
		AbstractOverlayElement.prototype.show.call(this);
	}
