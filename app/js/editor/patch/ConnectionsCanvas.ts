...
class ConnectionsCanvas extends EventDispatcher
{
    public drawDebugSelectionGrid = false; // draws the connection selection grid
    public viewOffset:IPoint;
    public connectionSelectionGrid:ConnectionsSelectionGrid;
    public connectionMouseOverIndex:number = -1;
    public $canvas:any;
    ...
    constructor(viewOffset:IPoint)
    {
        ...
        this.connectionSelectionGrid = new ConnectionsSelectionGrid(10, this.drawDebugSelectionGrid);
        ...
        this.$canvas.on('click', function(event) {
            ...
            if(this.connectionMouseOverIndex >= 0) this.dispatchEvent(ConnectionsCanvasEvent.CONNECTION_CLICKED, {connectionIndex: this.connectionMouseOverIndex});
        }.bind(this));
    }
    ...
    public draw(patch:Patch):void
    {
        ...
        // then draw all lines
        for(var i = 0; i < lineObjects.length; i++) this.drawLine(lineObjects[i]);
    ...
    public createLineSegments(connection:Connection, index:number):Array<any>
    {
        var segments = [];
    ...
    public drawWithCreation(patch:Patch, mouseX:number, mouseY:number):void
    {
    ...
    public drawLine(lineObject:any):void
    {
    ...
    public convertToCanvasSafeNumberfunction(value:number):number
    {
        return Math.round(value) + 0.5;
    }

    public findTransputByModuleIdAndIndex(moduleId, index, type):any
    {
