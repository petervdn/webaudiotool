define([
	'jquery',
	'ConnectionSelectionGrid',
	'ConnectionsCanvasEvent',
	'EventDispatcher'
], function (
	$,
	ConnectionSelectionGrid,
...
{	
	ConnectionsCanvas.prototype = Object.create(EventDispatcher.prototype);
	ConnectionsCanvas.prototype.constructor = ConnectionsCanvas;

	function ConnectionsCanvas(patch, viewOffset)
	{
		EventDispatcher.call(this);

		// draws the connection selection grid
		this.drawDebugSelectionGrid = false;

		this.viewOffset = viewOffset;
		this.connectionSelectionGrid = new ConnectionSelectionGrid(10, this.drawDebugSelectionGrid);
	...
	ConnectionsCanvas.prototype.draw = function(patch)
	{
		...
		var connections = patch.connections;
		for(var i = 0; i < connections.length; i++)
		{
			lineObjects.pushArray(this.createLineSegments(connections[i], i));
		}
	...
	ConnectionsCanvas.prototype.drawWithCreation = function(patch, mouseX, mouseY)
	{
		...
		{
			var lineObject = {connectionIndex: -1};
	...
	ConnectionsCanvas.prototype.convertToCanvasSafeNumber = function(number)
	{
